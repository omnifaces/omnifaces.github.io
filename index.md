...
It is a matter of dropping the [OmniFaces 3.11 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.11/) in `/WEB-INF/lib`.
...
For users who are still on JSF 2.2, use [2.7.11](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.11/) instead. The 2.x branch is in maintenance mode. For users on yet more outdated environments who can't/won't use CDI, use [1.14.1](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/1.14.1/) instead. It doesn't contain anything from CDI nor new things which were added in 2.x, but it does contain enhancements and bugfixes to existing 1.x things. Note that there is no 1.15 nor 1.16. The 1.14.1 is latest version of the 1.x branch which is also in maintenance mode.

If you are already on Jakarta EE 9 (e.g. WildFly 22, OpenLiberty 21, etc), then use [4.0-M8](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M8/) instead. It's the Jakartified version of 3.11.
...
- 4.0-M8 (4 Apr 2021, Jakartified 3.11, using Java 11) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M8/omnifaces-4.0-M8.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M8/omnifaces-4.0-M8-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M8/omnifaces-4.0-M8-javadoc.jar)
...
- 4.0-M6 (24 Jan 2021, BROKEN) - DO NOT USE IT! - Something went wrong during deploy to Maven central, the JAR is half baked :/
- 4.0-M5 (24 Jan 2021, Jakartified 3.10, using Java 11) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M5/omnifaces-4.0-M5.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M5/omnifaces-4.0-M5-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M5/omnifaces-4.0-M5-javadoc.jar)
...
- 3.11 (4 Apr 2021) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.11/omnifaces-3.11.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.11/omnifaces-3.11-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.11/omnifaces-3.11-javadoc.jar)
...
- 2.7.11 (4 Apr 2021) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.11/omnifaces-2.7.11.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.11/omnifaces-2.7.11-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.11/omnifaces-2.7.11-javadoc.jar)
- 2.7.10 (24 Jan 2021) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.10/omnifaces-2.7.10.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.10/omnifaces-2.7.10-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.10/omnifaces-2.7.10-javadoc.jar)
- 2.7.9 (19 Dec 2020) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.9/omnifaces-2.7.9.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.9/omnifaces-2.7.9-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.9/omnifaces-2.7.9-javadoc.jar)
