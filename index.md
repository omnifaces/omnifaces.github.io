[Download](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.6.5/omnifaces-4.6.5.jar) - [Showcase](https://showcase.omnifaces.org) - [API docs](https://omnifaces.org/docs/javadoc/current/) - [VDL docs](https://omnifaces.org/docs/vdldoc/current/) - [GitHub](https://github.com/omnifaces/omnifaces) - [Issues](https://github.com/omnifaces/omnifaces/issues) - [X](https://x.com/OmniFaces)
...
It is a matter of dropping the [OmniFaces 4.6.5 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.6.5/) in `/WEB-INF/lib`.
...
Or when you're using JSF 2.3, pick [OmniFaces 3.14.11](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.11/): 
...
Since OmniFaces 5.0 (currently only available as milestone release, with 5.0-M4 as latest), these are available under a single XML namespace:
...
- 3.14.11 (8 Jun 2025) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.11/omnifaces-3.14.11.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.11/omnifaces-3.14.11-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.11/omnifaces-3.14.11-javadoc.jar)
...
- 2.7.29 (8 Jun 2025) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.29/omnifaces-2.7.29.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.29/omnifaces-2.7.29-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.29/omnifaces-2.7.29-javadoc.jar)
