...
It is a matter of dropping the [OmniFaces 3.13 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.13/) in `/WEB-INF/lib`.
...
For users who are still on JSF 2.2, use [2.7.15](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.15/) instead. The 2.x branch is in maintenance mode. For users on yet more outdated environments who can't/won't use CDI, use [1.14.1](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/1.14.1/) instead. It doesn't contain anything from CDI nor new things which were added in 2.x, but it does contain enhancements and bugfixes to existing 1.x things. Note that there is no 1.15 nor 1.16. The 1.14.1 is latest version of the 1.x branch which is also in maintenance mode.

If you are already on Jakarta EE 9 (e.g. WildFly 22, OpenLiberty 21, etc) with JSF 3.0 or even Jakarta EE 10 with Faces 4.0, then use [4.0-M13](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M12/) instead. It's the Jakartified version of 3.13.
...
- 4.0-M13 (22 Jan 2022, Jakartified 3.13, using Java 11) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M13/omnifaces-4.0-M13.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M13/omnifaces-4.0-M13-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M13/omnifaces-4.0-M13-javadoc.jar)
...
- 3.13 (22 Jan 2022) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.13/omnifaces-3.13.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.13/omnifaces-3.13-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.13/omnifaces-3.13-javadoc.jar)
...
- 2.7.15 (22 Jan 2022) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.15/omnifaces-2.7.15.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.15/omnifaces-2.7.15-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.15/omnifaces-2.7.15-javadoc.jar)
