...
It is a matter of dropping the [OmniFaces 3.7 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.7/) in `/WEB-INF/lib`.
...
For users who are still on JSF 2.2, use [2.7.6](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.6/) instead. The 2.x branch is in maintenance mode. For users on yet more outdated environments who can't/won't use CDI, use [1.14.1](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/1.14.1/) instead. It doesn't contain anything from CDI nor new things which were added in 2.x, but it does contain enhancements and bugfixes to existing 1.x things. Note that there is no 1.15 nor 1.16. The 1.14.1 is latest version of the 1.x branch which is also in maintenance mode.
...
- 3.7 (12 July 2020) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.7/omnifaces-3.7.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.7/omnifaces-3.7-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.7/omnifaces-3.7-javadoc.jar)
