[Download](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3.1/omnifaces-5.3.1.jar) - [Showcase](https://showcase.omnifaces.org) - [API docs](https://omnifaces.org/docs/javadoc/current/) - [VDL docs](https://omnifaces.org/docs/vdldoc/current/) - [GitHub](https://github.com/omnifaces/omnifaces) - [Issues](https://github.com/omnifaces/omnifaces/issues) - [X](https://x.com/OmniFaces)
...
It is a matter of dropping the [OmniFaces 5.3.1 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3.1/) in `/WEB-INF/lib`.
...
Or when you're using Faces 4.0 or 3.0, pick [OmniFaces 4.7.7](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.7/): 
...
Or when you're still using JSF 2.3, pick [OmniFaces 3.14.18](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.18/): 

```xml
<dependency>
    <groupId>org.omnifaces</groupId>
    <artifactId>omnifaces</artifactId>
    <version>3.14.18</version>
</dependency>
```

The 4.x branch is in maintenance mode. I.e. New things won't be added there, but it'll receive bugfixes. For users who are still on JSF 2.3, use [3.14.18](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.18/). The 3.x branch is also in maintenance mode. I.e. it'll also only receive bugfixes.
...
- 5.3.1 (23 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3.1/omnifaces-5.3.1.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3.1/omnifaces-5.3.1-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3.1/omnifaces-5.3.1-javadoc.jar)
...
- 4.7.7 (23 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.7/omnifaces-4.7.7.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.7/omnifaces-4.7.7-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.7/omnifaces-4.7.7-javadoc.jar)
...
- 3.14.18 (23 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.18/omnifaces-3.14.18.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.18/omnifaces-3.14.18-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.18/omnifaces-3.14.18-javadoc.jar)
