[Download](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.4.1/omnifaces-4.4.1.jar) - [Showcase](https://showcase.omnifaces.org) - [API docs](https://omnifaces.org/docs/javadoc/current/) - [VDL docs](https://omnifaces.org/docs/vdldoc/current/) - [GitHub](https://github.com/omnifaces/omnifaces) - [Issues](https://github.com/omnifaces/omnifaces/issues) - [X](https://x.com/OmniFaces)
...
It is a matter of dropping the [OmniFaces 4.4.1 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.4.1/) in `/WEB-INF/lib`.
