...
It is a matter of dropping the [OmniFaces 3.4.1 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.4.1/) in `/WEB-INF/lib`.
...
For users who are still on JSF 2.2, use [2.7.3](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.3/) instead. The 2.x branch is in maintenance mode. For users on yet more outdated environments who can't/won't use CDI, use [1.14.1](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/1.14.1/) instead. It doesn't contain anything from CDI nor new things which were added in 2.x, but it does contain enhancements and bugfixes to existing 1.x things. Note that there is no 1.15 nor 1.16. The 1.14.1 is latest version of the 1.x branch which is also in maintenance mode.
...
- 2.7.3 (30 Nov 2019) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.3/omnifaces-2.7.3.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.3/omnifaces-2.7.3-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.3/omnifaces-2.7.3-javadoc.jar)
