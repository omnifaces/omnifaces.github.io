...
It is a matter of dropping the [OmniFaces 3.10.1 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.10.1/) in `/WEB-INF/lib`.
...
If you are already on Jakarta EE 9 (e.g. WildFly 22, OpenLiberty 21, etc), then use [4.0-M6](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M6/) instead. It's the Jakartified version of 3.10.1.
...
- 4.0-M6 (24 Jan 2021, Jakartified 3.10.1) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M6/omnifaces-4.0-M6.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M6/omnifaces-4.0-M6-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M6/omnifaces-4.0-M6-javadoc.jar)
- 4.0-M5 (24 Jan 2021, Jakartified 3.10) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M5/omnifaces-4.0-M5.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M5/omnifaces-4.0-M5-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M5/omnifaces-4.0-M5-javadoc.jar)
