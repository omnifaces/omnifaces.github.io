...
Or when you're using Faces 4.0 or 3.0, pick [OmniFaces 4.7.11](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.11/): 
...
Or when you're still using JSF 2.3, pick [OmniFaces 3.14.22](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.22/): 

```xml
<dependency>
    <groupId>org.omnifaces</groupId>
    <artifactId>omnifaces</artifactId>
    <version>3.14.22</version>
</dependency>
```

The 4.x branch is in maintenance mode. I.e. New things won't be added there, but it'll receive bugfixes. For users who are still on JSF 2.3, use [3.14.22](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.22/). The 3.x branch is also in maintenance mode. I.e. it'll also only receive bugfixes.

And users who are still on JSF 2.2, use [2.7.32](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.32/) instead. For users on yet more outdated environments who can't/won't use CDI, use [1.14.2](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/1.14.2/) instead. It doesn't contain anything from CDI nor new things which were added in 2.x, but it does contain enhancements and bugfixes to existing 1.x things. Note that there is no 1.15 nor 1.16. The 1.14.2 is latest version of the 1.x branch. The 2.x and 1.x branches are in securityfix mode. I.e. it'll only receive security fixes.
...
- 4.7.11 (14 Jul 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.11/omnifaces-4.7.11.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.11/omnifaces-4.7.11-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.11/omnifaces-4.7.11-javadoc.jar)
...
- 3.14.22 (14 Jul 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.22/omnifaces-3.14.22.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.22/omnifaces-3.14.22-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.22/omnifaces-3.14.22-javadoc.jar)
...
- 2.7.32 (15 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.32/omnifaces-2.7.32.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.32/omnifaces-2.7.32-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.32/omnifaces-2.7.32-javadoc.jar)
...
- 1.14.2 (15 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/1.14.2/omnifaces-1.14.2.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/1.14.2/omnifaces-1.14.2-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/1.14.2/omnifaces-1.14.2-javadoc.jar)
