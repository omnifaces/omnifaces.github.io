[Download](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.2.1/omnifaces-5.2.1.jar) - [Showcase](https://showcase.omnifaces.org) - [API docs](https://omnifaces.org/docs/javadoc/current/) - [VDL docs](https://omnifaces.org/docs/vdldoc/current/) - [GitHub](https://github.com/omnifaces/omnifaces) - [Issues](https://github.com/omnifaces/omnifaces/issues) - [X](https://x.com/OmniFaces)
...
It is a matter of dropping the [OmniFaces 5.2.1 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.2.1/) in `/WEB-INF/lib`.
...
Or when you're still using JSF 2.3, pick [OmniFaces 3.14.15](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.15/): 
...
The 4.x branch is in maintenance mode. I.e. New things won't be added there, but it'll receive bugfixes. For users who are still on JSF 2.3, use [3.14.15](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.15/). The 3.x branch is also in maintenance mode. I.e. it'll also only receive bugfixes.
...
- 5.2.1 (9 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.2.1/omnifaces-5.2.1.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.2.1/omnifaces-5.2.1-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.2.1/omnifaces-5.2.1-javadoc.jar)
...
- 3.14.15 (25 Mar 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.15/omnifaces-3.14.15.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.15/omnifaces-3.14.15-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.15/omnifaces-3.14.15-javadoc.jar)
...
- 2.7.31 (9 Mar 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.31/omnifaces-2.7.31.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.31/omnifaces-2.7.31-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/2.7.31/omnifaces-2.7.31-javadoc.jar)
