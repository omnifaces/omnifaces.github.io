[Download](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3.4/omnifaces-5.3.4.jar) - [Showcase](https://showcase.omnifaces.org) - [API docs](https://omnifaces.org/docs/javadoc/current/) - [VDL docs](https://omnifaces.org/docs/vdldoc/current/) - [GitHub](https://github.com/omnifaces/omnifaces) - [Issues](https://github.com/omnifaces/omnifaces/issues) - [X](https://x.com/OmniFaces)
...
It is a matter of dropping the [OmniFaces 5.3.4 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3.4/) in `/WEB-INF/lib`.
...
Or when you're using Faces 4.0 or 3.0, pick [OmniFaces 4.7.10](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.10/): 
...
Or when you're still using JSF 2.3, pick [OmniFaces 3.14.21](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.21/): 
...
The 4.x branch is in maintenance mode. I.e. New things won't be added there, but it'll receive bugfixes. For users who are still on JSF 2.3, use [3.14.21](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.21/). The 3.x branch is also in maintenance mode. I.e. it'll also only receive bugfixes.
...
- 4.7.10 (20 May 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.10/omnifaces-4.7.10.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.10/omnifaces-4.7.10-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.10/omnifaces-4.7.10-javadoc.jar)
...
- 3.14.21 (20 May 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.21/omnifaces-3.14.21.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.21/omnifaces-3.14.21-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.21/omnifaces-3.14.21-javadoc.jar)
