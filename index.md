[Download](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3/omnifaces-5.3.jar) - [Showcase](https://showcase.omnifaces.org) - [API docs](https://omnifaces.org/docs/javadoc/current/) - [VDL docs](https://omnifaces.org/docs/vdldoc/current/) - [GitHub](https://github.com/omnifaces/omnifaces) - [Issues](https://github.com/omnifaces/omnifaces/issues) - [X](https://x.com/OmniFaces)
...
It is a matter of dropping the [OmniFaces 5.3 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3/) in `/WEB-INF/lib`.
...
Or when you're using Faces 4.0 or 3.0, pick [OmniFaces 4.7.6](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.6/): 
...
Or when you're still using JSF 2.3, pick [OmniFaces 3.14.17](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.17/): 

```xml
<dependency>
    <groupId>org.omnifaces</groupId>
    <artifactId>omnifaces</artifactId>
    <version>3.14.17</version>
</dependency>
```

The 4.x branch is in maintenance mode. I.e. New things won't be added there, but it'll receive bugfixes. For users who are still on JSF 2.3, use [3.14.17](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.17/). The 3.x branch is also in maintenance mode. I.e. it'll also only receive bugfixes.
...
- 5.3 (23 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3/omnifaces-5.3.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3/omnifaces-5.3-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.3/omnifaces-5.3-javadoc.jar)
...
- 4.7.6 (23 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.6/omnifaces-4.7.6.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.6/omnifaces-4.7.6-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.6/omnifaces-4.7.6-javadoc.jar)
...
- 3.14.17 (23 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.17/omnifaces-3.14.17.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.17/omnifaces-3.14.17-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.17/omnifaces-3.14.17-javadoc.jar)
