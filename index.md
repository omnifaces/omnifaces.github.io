[Download](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.2.3/omnifaces-5.2.3.jar) - [Showcase](https://showcase.omnifaces.org) - [API docs](https://omnifaces.org/docs/javadoc/current/) - [VDL docs](https://omnifaces.org/docs/vdldoc/current/) - [GitHub](https://github.com/omnifaces/omnifaces) - [Issues](https://github.com/omnifaces/omnifaces/issues) - [X](https://x.com/OmniFaces)
...
It is a matter of dropping the [OmniFaces 5.2.3 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/5.2.3/) in `/WEB-INF/lib`.
...
Or when you're using Faces 4.0 or 3.0, pick [OmniFaces 4.7.5](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.5/): 
...
Or when you're still using JSF 2.3, pick [OmniFaces 3.14.16](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.16/): 
...
The 4.x branch is in maintenance mode. I.e. New things won't be added there, but it'll receive bugfixes. For users who are still on JSF 2.3, use [3.14.16](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.16/). The 3.x branch is also in maintenance mode. I.e. it'll also only receive bugfixes.
...
- 4.7.5 (15 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.5/omnifaces-4.7.5.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.5/omnifaces-4.7.5-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.7.5/omnifaces-4.7.5-javadoc.jar)
...
- 3.14.16 (15 Apr 2026) - [library](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.16/omnifaces-3.14.16.jar) - [sources](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.16/omnifaces-3.14.16-sources.jar) - [javadoc](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/3.14.16/omnifaces-3.14.16-javadoc.jar)
 ...
 * [OmniFaces API documentation](https://omnifaces.org/docs/javadoc/current/)
   - [5.2](https://omnifaces.org/docs/javadoc/5.2/) - [5.1](https://omnifaces.org/docs/javadoc/5.1/) - [5.0](https://omnifaces.org/docs/javadoc/5.0/)
 ...
 * [OmniFaces VDL documentation](https://omnifaces.org/docs/vdldoc/current/)
   - [5.2](https://omnifaces.org/docs/vdldoc/5.2/) - [5.1](https://omnifaces.org/docs/vdldoc/5.1/) - [5.0](https://omnifaces.org/docs/vdldoc/5.0/)
