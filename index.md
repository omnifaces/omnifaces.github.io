...
If you are already on Jakarta EE 9 (e.g. WildFly 22, OpenLiberty 21, etc), then use [4.0-M7](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.0-M7/) instead. It's the Jakartified version of 3.10.1.
