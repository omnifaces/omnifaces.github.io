...
It is a matter of dropping the [OmniFaces 4.1 JAR file](https://repo.maven.apache.org/maven2/org/omnifaces/omnifaces/4.1/) in `/WEB-INF/lib`.
 ...
 * [OmniFaces API documentation](https://omnifaces.org/docs/javadoc/current/)
   - [4.1](https://omnifaces.org/docs/javadoc/4.1/) - [4.0](https://omnifaces.org/docs/javadoc/4.0/)
 ...
 * [OmniFaces VDL documentation](https://omnifaces.org/docs/vdldoc/current/)
   - [4.1](https://omnifaces.org/docs/vdldoc/4.1/) - [4.0](https://omnifaces.org/docs/vdldoc/4.0/)
